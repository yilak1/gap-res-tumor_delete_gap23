...
def get_training_dataloader(batch_size=16, num_workers=2, shuffle=True):
    ...
    tumor_train = TumorTrain()
    tumor_train_loader = DataLoader(tumor_train, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers)
    return tumor_train_loader
